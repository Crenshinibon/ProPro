    ...
    var templates = function(key, locale) {
        ...
        var tpl = {
            ...
            "emphasis":
                "<li>" +
                  "<div class='btn-group'>" +
                    "<a class='btn' data-wysihtml5-command='bold' title='CTRL+B'><span style='font-weight: bolder;'>B</span></a>" +
                    "<a class='btn' data-wysihtml5-command='italic' title='CTRL+I'><span style='font-style: italic;'>I</span></a>" +
                    "<a class='btn' data-wysihtml5-command='underline' title='CTRL+U'><span style='text-decoration: underline;'>U</span></a>" +
                  "</div>" +
                "</li>",
